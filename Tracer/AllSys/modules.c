...
int syscall_rt_sigtimedwait_time32(void *ctx) {
    ...
    if (uts_name){
        bpf_trace_printk("%s:rt_sigtimedwait_time32\n", get_task_uts_name(task));
    }
    return 0;
}
...
int syscall_sched_rr_get_interval_time32(void *ctx) {
    ...
    if (uts_name){
        bpf_trace_printk("%s:sched_rr_get_interval_time32\n", get_task_uts_name(task));
    }
    return 0;
}
...
int syscall_adjtimex_time32(void *ctx) {
    ...
    if (uts_name){
        bpf_trace_printk("%s:adjtimex_time32\n", get_task_uts_name(task));
    }
    return 0;
}
...
int syscall_nanosleep_time32(void *ctx) {
    ...
    if (uts_name){
        bpf_trace_printk("%s:nanosleep_time32\n", get_task_uts_name(task));
    }
    return 0;
}
...
int syscall_timer_gettime32(void *ctx) {
    ...
    if (uts_name){
        bpf_trace_printk("%s:timer_gettime32\n", get_task_uts_name(task));
    }
    return 0;
}
...
int syscall_timer_settime32(void *ctx) {
    ...
    if (uts_name){
        bpf_trace_printk("%s:timer_settime32\n", get_task_uts_name(task));
    }
    return 0;
}
...
int syscall_clock_gettime32(void *ctx) {
    ...
    if (uts_name){
        bpf_trace_printk("%s:clock_gettime32\n", get_task_uts_name(task));
    }
    return 0;
}
...
int syscall_clock_settime32(void *ctx) {
    ...
    if (uts_name){
        bpf_trace_printk("%s:clock_settime32\n", get_task_uts_name(task));
    }
    return 0;
}
...
int syscall_clock_getres_time32(void *ctx) {
    ...
    if (uts_name){
        bpf_trace_printk("%s:clock_getres_time32\n", get_task_uts_name(task));
    }
    return 0;
}
...
int syscall_clock_nanosleep_time32(void *ctx) {
    ...
    if (uts_name){
        bpf_trace_printk("%s:clock_nanosleep_time32\n", get_task_uts_name(task));
    }
    return 0;
}
...
int syscall_clock_adjtime32(void *ctx) {
    ...
    if (uts_name){
        bpf_trace_printk("%s:clock_adjtime32\n", get_task_uts_name(task));
    }
    return 0;
}
...
int syscall_futex_time32(void *ctx) {
    ...
    if (uts_name){
        bpf_trace_printk("%s:futex_time32\n", get_task_uts_name(task));
    }
    return 0;
}
...
int syscall_setresuid16(void *ctx) {
    ...
    if (uts_name){
        bpf_trace_printk("%s:setresuid16\n", get_task_uts_name(task));
    }
    return 0;
}
...
int syscall_setresgid16(void *ctx) {
    ...
    if (uts_name){
        bpf_trace_printk("%s:setresgid16\n", get_task_uts_name(task));
    }
    return 0;
}
...
int syscall_getgroups16(void *ctx) {
    ...
    if (uts_name){
        bpf_trace_printk("%s:getgroups16\n", get_task_uts_name(task));
    }
    return 0;
}
...
int syscall_setgroups16(void *ctx) {
    ...
    if (uts_name){
        bpf_trace_printk("%s:setgroups16\n", get_task_uts_name(task));
    }
    return 0;
}
...
int syscall_getresuid16(void *ctx) {
    ...
    if (uts_name){
        bpf_trace_printk("%s:getresuid16\n", get_task_uts_name(task));
    }
    return 0;
}
...
int syscall_getresgid16(void *ctx) {
    ...
    if (uts_name){
        bpf_trace_printk("%s:getresgid16\n", get_task_uts_name(task));
    }
    return 0;
}
...
int syscall_print_type_x64(void *ctx) {
    struct task_struct *task;
    task = (struct task_struct *)bpf_get_current_task();
    char * uts_name = get_task_uts_name(task);

    if (uts_name){
        bpf_trace_printk("%s:print_type_x64\n", get_task_uts_name(task));
    }
    return 0;
}
...
int syscall_old_readdir(void *ctx) {
    ...
    if (uts_name){
        bpf_trace_printk("%s:old_readdir\n", get_task_uts_name(task));
    }
    return 0;
}
...
int syscall_futimesat_time32(void *ctx) {
    ...
    if (uts_name){
        bpf_trace_printk("%s:futimesat_time32\n", get_task_uts_name(task));
    }
    return 0;
}
...
int syscall_utimes_time32(void *ctx) {
    ...
    if (uts_name){
        bpf_trace_printk("%s:utimes_time32\n", get_task_uts_name(task));
    }
    return 0;
}
...
int syscall_utimensat_time32(void *ctx) {
    ...
    if (uts_name){
        bpf_trace_printk("%s:utimensat_time32\n", get_task_uts_name(task));
    }
    return 0;
}
...
int syscall_timerfd_gettime32(void *ctx) {
    ...
    if (uts_name){
        bpf_trace_printk("%s:timerfd_gettime32\n", get_task_uts_name(task));
    }
    return 0;
}
...
int syscall_timerfd_settime32(void *ctx) {
    ...
    if (uts_name){
        bpf_trace_printk("%s:timerfd_settime32\n", get_task_uts_name(task));
    }
    return 0;
}
...
int syscall_io_getevents_time32(void *ctx) {
    ...
    if (uts_name){
        bpf_trace_printk("%s:io_getevents_time32\n", get_task_uts_name(task));
    }
    return 0;
}
...
int syscall_debugfs_create_x64(void *ctx) {
    struct task_struct *task;
    task = (struct task_struct *)bpf_get_current_task();
    char * uts_name = get_task_uts_name(task);

    if (uts_name){
        bpf_trace_printk("%s:debugfs_create_x64\n", get_task_uts_name(task));
    }
    return 0;
}
...
int syscall_semtimedop_time32(void *ctx) {
    ...
    if (uts_name){
        bpf_trace_printk("%s:semtimedop_time32\n", get_task_uts_name(task));
    }
    return 0;
}
...
int syscall_mq_timedsend_time32(void *ctx) {
    ...
    if (uts_name){
        bpf_trace_printk("%s:mq_timedsend_time32\n", get_task_uts_name(task));
    }
    return 0;
}
...
int syscall_mq_timedreceive_time32(void *ctx) {
    ...
    if (uts_name){
        bpf_trace_printk("%s:mq_timedreceive_time32\n", get_task_uts_name(task));
    }
    return 0;
}
...
int syscall_recvmmsg_time32(void *ctx) {
    ...
    if (uts_name){
        bpf_trace_printk("%s:recvmmsg_time32\n", get_task_uts_name(task));
    }
    return 0;
}
